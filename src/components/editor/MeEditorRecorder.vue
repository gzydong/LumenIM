      ...
      <el-container class="hv100">
        ...
        <el-main class="padding0 mian">
          ...
          <div style="margin-top: 35px;color: #676262;font-weight: 300;">
            ...
            <template v-else-if="recorderStatus == 1 || recorderStatus == 2 || recorderStatus == 3">
              <p>{{datetime}}</p>
              <p style="font-size: 13px;margin-top: 5px;">
            ...
            <template v-else-if="recorderStatus == 4 || recorderStatus == 5 || recorderStatus == 6">
              <p>{{formatPlayTime}}</p>
              <p style="font-size: 13px;margin-top: 5px;">
        ...
        <el-footer class="footer" height="50px">
          ...
          <el-button type="primary" icon="el-icon-microphone" v-show="recorderStatus == 0" size="mini" round
            @click="startRecorder">开始录音</el-button>
          <el-button type="primary" icon="el-icon-video-pause" v-show="recorderStatus == 1" size="mini" round
            @click="pauseRecorder">暂停录音
          </el-button>
          <el-button type="primary" icon="el-icon-microphone" v-show="recorderStatus == 2" size="mini" round
            @click="resumeRecorder">继续录音
          </el-button>
          <el-button type="primary" icon="el-icon-microphone" v-show="recorderStatus == 2"
            size="mini" round @click="stopRecorder">结束录音
          </el-button>

          <el-button type="primary" icon="el-icon-video-play" v-show="recorderStatus == 3 || recorderStatus == 6"
            size="mini" round @click="playRecorder">播放录音
          </el-button>

          <el-button type="primary" icon="el-icon-video-play" v-show="recorderStatus == 3 || recorderStatus == 5 || recorderStatus == 6"
            size="mini" round @click="startRecorder">重新录音
          </el-button>


          <el-button type="primary" icon="el-icon-video-pause" v-show="recorderStatus == 4" size="mini" round
            @click="pausePlayRecorder">暂停播放
          </el-button>
          <el-button type="primary" icon="el-icon-video-play" v-show="recorderStatus == 5" size="mini" round
            @click="resumePlayRecorder">继续播放
          </el-button>

          <el-button type="primary" v-show="recorderStatus == 3 || recorderStatus == 5  || recorderStatus == 6"
            size="mini" round @click="submit">立即发送
          </el-button>
        </el-footer>
      </el-container>
    </div>
