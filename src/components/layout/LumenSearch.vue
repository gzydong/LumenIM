<template>
  <div class="lumen-search">
    ...
    <input type="text" ref="lumenSearchInput" :placeholder="placeholder" v-model="search" @keyup.enter="change"
      class="lumen-search-input" :class="{'lumen-bg-white':search?true:false}">
