...
const suggestions = ref([
  `多人讨论购买、销售和团购各种商品\n\n
讨论了购买草莓、空气炸锅等商品的问题。
有人提出销售丹东草莓、第六季会员卡等商品。
有人参与团购活动，并分享相关链接。
讨论了空气炸锅、洗漱包、露营车等商品的出售和价格问题。`,
`服务限流、API网关鉴权失败、卡片创建相关问题
杨晓冬指导如何查询gz 接口的qps。
郭智宸询问产品配额开通权限的方法。
郭巧彪询问订单执行器是否符合预期。
王剑飞反馈API网关鉴权失败，请求ip不在允许范围内。
苏林刚询问API限流信息是否来自console hub，并请求了requestId。
曾科反馈tag服务请求报TagExceptions.LimitExceeded。`
]);
