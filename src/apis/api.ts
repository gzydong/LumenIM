...
import type {
  ...
  GroupNoticeDeleteRequest,
  GroupNoticeDeleteResponse,
  GroupNoticeEditRequest,
  GroupNoticeEditResponse,
  GroupNoticeListRequest,
  GroupNoticeListResponse,
 ...
 * 删除群组公告接口
 */
export const fetchGroupNoticeDelete = createApi<GroupNoticeDeleteRequest, GroupNoticeDeleteResponse>(
  '/api/v1/group-notice/delete',
  { method: 'POST' }
)
 ...
 * 获取群组公告列表接口
 */
export const fetchGroupNoticeList = createApi<GroupNoticeListRequest, GroupNoticeListResponse>(
  '/api/v1/group-notice/list',
  { method: 'POST' }
)
